        ...
        <?php foreach ($jobs as $job) { ?>
            <div class="jobs-list__job d-flex">
                ...
                <div class="jobs-list__job-info">
                    <div class="jobs-list__job-header d-flex align-items-center justify-content-between">
                        <div class="jobs-list__job-name">Salonu Belviso potreban <?php echo $job['name'] ?></div>
                        <div class="jobs-list__job-logo"><?php get_template_part('partials/icons/logo-icon'); ?></div>
                    </div>

                    <div class="jobs-list__job-contact d-flex align-items-center justify-content-between">
